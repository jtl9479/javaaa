...
public class Ex0518_4_2 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			switch (choice) {
			case 1:// 학생성적입력
				stuInput(s);//s를 넣어 아래에 만든 메소드와 연결한다.매개변수 s보냄
				break;
	...
	//main출력화면 메소드
	static void mainPrint() {//값을 받아오지않고 단순히 출력하는 경우에는 괄호안에다가 값을 넣을 필요가없다
	...
	static void stuInput(Student2[] s) {
		...
		for (int i = Student2.count; i < s.length; i++) {//s는 메인메소드안에있다 메소드가 달라서 에러가나온다
