...
//출력
public class ex0514_2input_output {
	...
	public static void main(String[] args) {
		...
		loop1: while (true) {
			...
			case 1:
				...
				// 프로그램 추가
				for (int i = count; i < name.length; i++) {// 초기값을 0이 아니라 count로 주는 이유가 1명을 검색하고 나갔을때 초깃값이 0이면 다시 처음부터 입력을하게 된다 그래서 카운터로 주면 갯수가 카운터에 ㅓ장되 그 이후부터 값이 저장된더
