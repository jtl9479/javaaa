	...
	public static void main(String[] args) {
		...
		loop1: while (true) {
			...
			case 2:// 프로그램 수정
				...
				System.out.println(subject[subjectNum - 1] + "현재 점수 : " + score[searchNum][subjectNum - 1]);// 현재점수를
																											// 알수있다.
																											// subject[]
																											// 과목 정보
																											// score[][]
				...
				score[searchNum][subjectNum - 1] = scan.nextInt();// 점수가 들어있는 배열에다가 바로 입력값을 넣는다.
